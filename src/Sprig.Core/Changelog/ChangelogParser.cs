...
namespace Sprig.Core.Changelog;
...
/// and hands it in. Headings look like <c>## [v0.1.0] - 2026-07-22</c>; the <c>v0.1.0</c> is the version.
/// </summary>
public static class ChangelogParser
{
    static readonly Regex VersionRx = new(@"v?(\d+(?:\.\d+){1,3})", RegexOptions.Compiled);
    ...
    /// <summary>Pulls a <see cref="System.Version"/> out of a heading like <c>[v0.1.0] - 2026-07-22</c>.</summary>
    ...
    static bool TryParse(string? version, out Version? parsed)
    {
        parsed = null;
